...
For the current `invDesMobility` 2D-mobility workflow, use the step-by-step manual here:

- [00_project/README_MOBILITY2D_PIPELINE.md](../../00_project/README_MOBILITY2D_PIPELINE.md)
